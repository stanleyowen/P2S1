        ...
        <div className="header">
            <div className="header-main">
                <div className="header-logo">
                    <Image src="./Logo P2S1.png" alt="P2S1 logo" layout="fill" unoptimized />
                </div>
            ...
            <div className="header-menu" style={headerExpanded ? { width: '100%' } : {}}>
                <span className="header-exit-menu" onClick={() => setheaderExpanded(false)}>
                    ×
                </span>
                <Link href="/">About</Link>
                <Link href="./2023">P2S1 XXVI - 2023</Link>
            </div>
        </div>
    );
};
